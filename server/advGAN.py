...
class AdvGAN_Attack:
    ...
    def train_batch(self, x, labels, lengths):
        # optimize D
        for i in range(1):
        ...
        for i in range(1):
            ...
            optimizer = optim.RMSprop(self.model.parameters(), lr=0.1, alpha = 0.9, eps=1e-08,
                         momentum=0.9, weight_decay=2e-5)
            T_length = 18
            logits_model = self.model(adv_images)
            input_lengths, target_lengths = self.sparse_tuple_for_ctc(T_length, lengths)
            log_probs = logits_model.permute(2, 0, 1) # for ctc loss: T x N x C
            # print(labels.shape)
        ...
        return loss_D_GAN.item(), loss_G_fake.item(), loss_perturb, loss_adv
        ...
        for epoch in range(1, epochs+1):
            ...
            for i, data in enumerate(train_dataloader, start=0):
                ...
                loss_D_batch, loss_G_fake_batch, loss_perturb_batch, loss_adv_batch = \
                    self.train_batch(images, labels, lengths)
